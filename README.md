...
For further information, please have a look at the manpages of [pftbld(8)](https://mpfr.net/man/pftbld/7.5-stable/pftbld.8.html), its configuration file [pftbld.conf(5)](https://mpfr.net/man/pftbld/7.5-stable/pftbld.conf.5.html), and its control tool [pftblctl(8)](https://mpfr.net/man/pftbld/7.5-stable/pftblctl.8.html).
...
* [httpd(8)](http://man.openbsd.org/httpd)
	* via FastCGI as outlined in [pftbld.conf(5)](https://mpfr.net/man/pftbld/7.5-stable/pftbld.conf.5.html#EXAMPLES)
...
First of all, make sure you're running `OpenBSD 7.5-stable`. Otherwise, one of the following branches might be more appropriate:
...
$ pwd
/home/mpfr
$ doas rm -rf pftbld-7.5-stable/
$ ftp -Vo - https://codeload.github.com/mpfr/pftbld/tar.gz/7.5-stable | tar xzvf -
pftbld-7.5-stable
pftbld-7.5-stable/LICENSE
pftbld-7.5-stable/README.md
pftbld-7.5-stable/docs
pftbld-7.5-stable/docs/pftblctl.8.html
pftbld-7.5-stable/docs/pftbld.8.html
pftbld-7.5-stable/docs/pftbld.conf.5.html
pftbld-7.5-stable/pkg
pftbld-7.5-stable/pkg/pftbld.conf
pftbld-7.5-stable/pkg/pftbld.rc
pftbld-7.5-stable/src
pftbld-7.5-stable/src/Makefile
pftbld-7.5-stable/src/config.c
pftbld-7.5-stable/src/listener.c
pftbld-7.5-stable/src/log.c
pftbld-7.5-stable/src/log.h
pftbld-7.5-stable/src/logger.c
pftbld-7.5-stable/src/parse.y
pftbld-7.5-stable/src/persist.c
pftbld-7.5-stable/src/pftblctl.8
pftbld-7.5-stable/src/pftblctl.sh
pftbld-7.5-stable/src/pftbld.8
pftbld-7.5-stable/src/pftbld.c
pftbld-7.5-stable/src/pftbld.conf.5
pftbld-7.5-stable/src/pftbld.h
pftbld-7.5-stable/src/scheduler.c
pftbld-7.5-stable/src/sockpipe.c
pftbld-7.5-stable/src/tinypfctl.c
pftbld-7.5-stable/src/util.c
```

Compile the source files.

```
$ cd pftbld-7.5-stable/src
$ doas make
yacc  -o parse.c parse.y
cc -O2 -pipe  -Wall -I/home/mpfr/pftbld-7.5-stable/src -Wstrict-prototypes ...
.
.
.
...
install -c -o root -g bin -m 555  /home/mpfr/pftbld-7.5-stable/src/pftblctl.sh ...
...
install -c -o root -g bin -m 555  /home/mpfr/pftbld-7.5-stable/src/../pkg/pftbld...
useradd -c "pftbld unprivileged user" -d /var/empty -g =uid -r 100..999 -s ...
cp /home/mpfr/pftbld-7.5-stable/src/../pkg/pftbld.conf /etc/pftbld
```
...
Adapt the [sample](pkg/pftbld.conf) [configuration file](https://mpfr.net/man/pftbld/7.5-stable/pftbld.conf.5.html) at `/etc/pftbld/pftbld.conf` to your needs. Make sure your configuration is valid.
...
```
$ doas rm -rf /etc/pftbld ~/pftbld-7.5-stable
```
